...
msgno_to_str(unsigned short n)
{
    return
        ...
        (n == E_EICP_CERT_LOGIN_REQUEST) ? "EICP_CERT_LOGIN_REQUEST" :
                             ...
                             int scp_fd)
{
    ...
    if (rv == 0)
    {
        rv = libipm_msg_out_append(trans, "sh", ip_addr, scp_fd);
    }
                            ...
                            int *scp_fd)
{
    ...
    *cert_len = 0;
    ...
    rv = libipm_msg_in_parse(trans, "Bsh",
